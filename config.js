...
const slideData = [
  {
    ...
    desc: `Our unit manages secure cloud-hosted CCTV solutions covering hospital entrances, perimeters, and critical zones.
Real-time monitoring and instant alerts enhance safety for patients and staff while supporting regulatory compliance.`
  },
  {
    ...
    title: "Medserve IT Unit - 2️⃣ Cancer Patient Companion App",
...
We have implemented touchless gesture recognition in clinical areas for both patients and staff. This technology enables feedback submission by simply waving, and interface control without physical contact, reducing contamination risks. The system also improves workflow efficiency and response times in sterile environments.`
  },
  {
    ...
    title: "Medserve IT Unit - 4️⃣ Carepath Monitoring Toolset",
...
Overall, it ensures organized, timely, and seamless monitoring of patient progression across the treatment pathway.`
  },
  {
    ...
    desc: `The Medserve IT Unit developed a robust color-coded Treatment Stage Tracker integrated into the ARIA system.
It ensures no patient is missed by accurately tracking every case from the GE CT simulator to ARIA via the DICOM bridge.
The tool helps the Radiotherapy team verify daily scanned patient counts and provides clear reporting for consistency and accountability.`
  },
  {
...
This approach shortens the visit-to-treatment timeline, delivering a faster, more seamless care experience.`
  ...
  {
    img: "./images/imagepayment-tracker.jpg",
